...
# =============================================================================
# DeepfakeJudge — Pairwise Training Script (NVIDIA GPUs)
#
# Fine-tunes a Qwen2.5-VL model for pairwise reasoning evaluation using
...
#   DATASET      — Path to the pairwise training JSONL file
